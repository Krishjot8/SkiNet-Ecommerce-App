...
using Stripe;
using Product = ECommerce_App.Models.Product;
    ...
    public class PaymentService : IPaymentService
    {
        ...
        public async Task<CustomerBasket> CreateOrUpdatePaymentIntent(string basketId)
        {
            ...
            if(basket.DeliveryMethodId.HasValue)
            {
                ...
                var deliveryMethod = await _unitOfWork.Repository<DeliveryMethod>()  //if has value we will go get delivery method from database
